namespace DarkSky.Tests.UnitTests.Models
{
    ...
    public class AlertUnitTests : IClassFixture<ResponseFixture>
    {
        ...
        {
            var forecast = _fixture.AlertResponse; // Thursday, September 20, 2018 4:00:00 AM UTC
        ...
        {
            var forecast = _fixture.AlertResponse; // Thursday, September 20, 2018 10:00:00 PM UTC
