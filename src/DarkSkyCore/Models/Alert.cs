namespace DarkSky.Models
{
	...
	/// <summary>
	/// The alerts array contains objects representing the severe weather warnings issued for the requested location by a governmental authority (please see our <a href="https://darksky.net/dev/docs/sources">data sources page</a> for a list of sources).
	/// </summary>
	public class Alert
	{
		/// <summary>
		...
		/// <summary>
		/// A <see cref="List{T}"/> of strings representing the names of the regions covered by this weather alert.
		/// </summary>
